<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Restaruante.aspx.cs" Inherits="Restaruante" %>


<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <asp:Label ID="Lblbienvenido" runat="server" Visible="false" Text="Bienvenido: " CssClass="AltaRestaurantes"></asp:Label>
   <asp:Menu CssClass="MenuRestaurantes" ID="MnRestaruantes" runat="server" Orientation="Horizontal" >
       <Items>    
